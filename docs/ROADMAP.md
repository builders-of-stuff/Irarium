...
Ideas and features to explore, organized by theme
...
Key ideas: 3D tunnel visualization, music player aesthetic, interactive storytelling, spatial coordinates, physical placement

## Space & Economy System

Coin-based ecosystem where users own and upgrade personal spaces. Start small, expand over time, create networks of connected thoughts.

**[→ Full feature doc](./features/space-economy.md)**

Key ideas: Personal 3D spaces, coin economy, space upgrades, irarium linking, monetization model

## Web3

- Creating/reading irarium objects (Sui)
