...
A coin-based ecosystem where users can own, customize, and expand their personal spaces for irariums. Think of it like owning digital real estate—start small, grow over time, and create a network of connected thoughts.
...
- Increased storage capacity for ideas
...
- Reward quality content creation
...
- Collaborative spaces with shared ownership
- Public link graph for discovery
...
- Daily login bonuses
- Completing challenges/milestones
- Referral rewards
...
- Avoid pay-to-win, maintain free-tier viability
...
- Balance free vs. paid experiences

## Open Questions

- What's the right coin:dollar ratio?
- Should coins expire or accumulate indefinitely?
- How to prevent inflation or gaming the system?
- What makes spaces feel valuable enough to upgrade?
- Should there be a marketplace for trading spaces/themes?
